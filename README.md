...
1. Click the **Launch on AWS** button to open the solution in the CloudFormation console.
    ...
    [![Launch the Amazon CloudFront secure static website with CloudFormation](./docs/images/deploy-to-aws.png)](https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=amazon-cloudfront-secure-static-site-templates-main&templateURL=https://s3.amazonaws.com/public.cloud.cit.cornell.edu/cloudformation/amazon-cloudfront-secure-static-site/main.yaml)
